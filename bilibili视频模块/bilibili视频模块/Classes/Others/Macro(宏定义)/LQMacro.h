...
// APP主题颜色
#define LQMainColor Color(251, 114, 153)
#define LQNavTintColor Color(145, 145, 141)
#define LQBackgroundColor Color(242, 244, 244)


#define LQlachImageBack [UIImage imageNamed:@"videopic_default"]
#define LQlachIcon [UIImage imageNamed:@"misc_avatarDefault_50x50"]
 ...
 *  Docment文件夹目录
 */
#define LQDocumentPath NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES).firstObject

/**
 *  下载文件夹目录
 */
#define LQDownloadPath [LQDocumentPath stringByAppendingPathComponent: @"download"]
/**
 *  VideoModel归档文件夹目录
 */
#define LQArchPath [LQDocumentPath stringByAppendingPathComponent: @"arch"]
